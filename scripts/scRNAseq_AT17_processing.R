...
#raw data processing
if(T){
  out_dir="/path/to/AT17_RDS"
  system(paste0("mkdir -p ",out_dir))
  tc.data <- Read10X(data.dir = "/path/to/Thy17_GEX/outs/filtered_feature_bc_matrix/")
