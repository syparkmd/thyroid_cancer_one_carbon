...
#raw data processing
if(T){
  out_dir="/path/to/AT16_RDS"
  system(paste0("mkdir -p ",out_dir))
  tc.data <- Read10X(data.dir = "/path/to/Thy16_GEX/outs/filtered_feature_bc_matrix/")
